...
var _datamaps = __webpack_require__(2);
...
var _map_maker = __webpack_require__(11);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var arcDraw = function arcDraw(mode, target) {
  d3.selectAll('.datamaps-subunit').on('click', function (d, i) {
    var data = map.options.data[d.id];
    var w = data.totalNum ? data.totalNum : 0;
    if (mode === 'Exports') {
      if (d.id !== target) {
...
toggleButton.addEventListener('click', function () {
  while (_map_maker.mapDiv.firstChild) {
    _map_maker.mapDiv.removeChild(_map_maker.mapDiv.firstChild);
  }
  mode = toggleButton.value;
  if (toggleButton.value === 'Imports') {
    toggleButton.value = 'Exports';
    map = (0, _map_maker.mapMaker)(_data.IMPORT_DATA, startYear, endYear);
    pathButton.value = 'See All Paths';
  } else {
    toggleButton.value = 'Imports';
    map = (0, _map_maker.mapMaker)(_data.EXPORT_DATA, startYear, endYear);
    pathButton.value = 'See All Paths';
  }
  arcDraw(mode, 'USA');
});
...
pathButton.addEventListener('click', function () {
  if (pathButton.value === 'See All Paths') {
    ...
    var keys = Object.keys(map.options.data);
    console.log(keys);
    var arcs = [];
    for (var i = 0; i < keys.length; i++) {
      if (keys[i] !== 'USA') {
        var origin = mode === 'Imports' ? keys[i] : 'USA';
        var destination = mode === 'Imports' ? 'USA' : keys[i];
        var strokeWidth = 2 * Math.trunc(Math.log(map.options.data[keys[i]].totalNum + 1));
        console.log(arcs);
        arcs.push({ origin: origin, destination: destination, strokeWidth: strokeWidth });
      }
    }
    map.arc(arcs);
  } else {
...
var startBar = document.getElementById('start');
var endBar = document.getElementById('end');
startBar.addEventListener('change', function () {
  startYear = startBar.value;
  while (_map_maker.mapDiv.firstChild) {
    _map_maker.mapDiv.removeChild(_map_maker.mapDiv.firstChild);
  }
  startYear = startBar.value;
  var opts = endBar.getElementsByTagName("option");
...
endBar.addEventListener('change', function () {
  endYear = endBar.value;
  while (_map_maker.mapDiv.firstChild) {
    _map_maker.mapDiv.removeChild(_map_maker.mapDiv.firstChild);
  }
  endYear = endBar.value;
  var opts = startBar.getElementsByTagName("option");
  for (var i = 0; i < opts.length; i++) {
...
// Initial map drawer
var map = (0, _map_maker.mapMaker)(_data.EXPORT_DATA, startYear, endYear);
arcDraw('Exports', 'USA');
...
var EXPORT_DATA = exports.EXPORT_DATA = {
   "Afghanistan": {
      "2001": null,
      "2002": null,
      "2003": null,
...
var IMPORT_DATA = exports.IMPORT_DATA = {
   "Australia": {
      "2001": 42,
      "2002": 30,
      "2003": 30,
...
var _name_to_id = __webpack_require__(6);

var stringCalc = function stringCalc(volume) {
  if (volume === null) {
    return "$0";
  }if (volume === 0) {
...
var fillCalc = function fillCalc(volume) {
  if (volume === null) {
    return 'defaultFill';
  } else if (volume <= 10) {
    return 'oneToTen';
...
var totalCalc = function totalCalc(start, end, obj) {
  var total = obj[start];
  if (start < end) {
...
var dataFormater = function dataFormater(dataset, start, end) {
  var keys = Object.keys(dataset);
  var outputData = {};
  for (var i = 0; i < keys.length; i++) {
    var total = totalCalc(start, end, dataset[keys[i]]);
    outputData[_name_to_id.nameToId[keys[i]]] = {
      totalNum: total,
...
var nameToId = exports.nameToId = { "Afghanistan": "AFG", "Angola": "AGO", "Albania": "ALB", "United Arab Emirates": "ARE", "Argentina": "ARG", "Armenia": "ARM", "Antarctica": "ATA", "French Southern and Antarctic Lands": "ATF", "Australia": "AUS", "Austria": "AUT", "Azerbaijan": "AZE", "Burundi": "BDI", "Belgium": "BEL", "Benin": "BEN", "Burkina Faso": "BFA", "Bangladesh": "BGD", "Bulgaria": "BGR", "The Bahamas": "BHS", "Bosnia and Herzegovina": "BIH", "Belarus": "BLR", "Belize": "BLZ", "Bolivia": "BOL", "Brazil": "BRA", "Brunei": "BRN", "Bhutan": "BTN", "Botswana": "BWA", "Central African Republic": "CAF", "Canada": "CAN", "Switzerland": "CHE", "Chile": "CHL", "China": "CHN", "Ivory Coast": "CIV", "Cameroon": "CMR", "Democratic Republic of the Congo": "COD", "Republic of the Congo": "COG", "Colombia": "COL", "Costa Rica": "CRI", "Cuba": "CUB", "Northern Cyprus": "-99", "Cyprus": "CYP", "Czech Republic": "CZE", "Germany": "DEU", "Djibouti": "DJI", "Denmark": "DNK", "Dominican Republic": "DOM", "Algeria": "DZA", "Ecuador": "ECU", "Egypt": "EGY", "Eritrea": "ERI", "Spain": "ESP", "Estonia": "EST", "Ethiopia": "ETH", "Finland": "FIN", "Fiji": "FJI", "Falkland Islands": "FLK", "France": "FRA", "French Guiana": "GUF", "Gabon": "GAB", "United Kingdom": "GBR", "Georgia": "GEO", "Ghana": "GHA", "Guinea": "GIN", "Gambia": "GMB", "Guinea Bissau": "GNB", "Equatorial Guinea": "GNQ", "Greece": "GRC", "Greenland": "GRL", "Guatemala": "GTM", "Guyana": "GUY", "Honduras": "HND", "Croatia": "HRV", "Haiti": "HTI", "Hungary": "HUN", "Indonesia": "IDN", "India": "IND", "Ireland": "IRL", "Iran": "IRN", "Iraq": "IRQ", "Iceland": "ISL", "Israel": "ISR", "Italy": "ITA", "Jamaica": "JAM", "Jordan": "JOR", "Japan": "JPN", "Kazakhstan": "KAZ", "Kenya": "KEN", "Kyrgyzstan": "KGZ", "Cambodia": "KHM", "South Korea": "KOR", "Kosovo": "-99", "Kuwait": "KWT", "Laos": "LAO", "Lebanon": "LBN", "Liberia": "LBR", "Libya": "LBY", "Sri Lanka": "LKA", "Lesotho": "LSO", "Lithuania": "LTU", "Luxembourg": "LUX", "Latvia": "LVA", "Morocco": "MAR", "Moldova": "MDA", "Madagascar": "MDG", "Mexico": "MEX", "Macedonia": "MKD", "Mali": "MLI", "Myanmar": "MMR", "Montenegro": "MNE", "Mongolia": "MNG", "Mozambique": "MOZ", "Mauritania": "MRT", "Malawi": "MWI", "Malaysia": "MYS", "Namibia": "NAM", "New Caledonia": "NCL", "Niger": "NER", "Nigeria": "NGA", "Nicaragua": "NIC", "Netherlands": "NLD", "Norway": "NOR", "Nepal": "NPL", "New Zealand": "NZL", "Oman": "OMN", "Pakistan": "PAK", "Panama": "PAN", "Peru": "PER", "Philippines": "PHL", "Papua New Guinea": "PNG", "Poland": "POL", "Puerto Rico": "PRI", "North Korea": "PRK", "Portugal": "PRT", "Paraguay": "PRY", "Qatar": "QAT", "Romania": "ROU", "Russia": "RUS", "Rwanda": "RWA", "Western Sahara": "ESH", "Saudi Arabia": "SAU", "Sudan": "SDN", "South Sudan": "SSD", "Senegal": "SEN", "Solomon Islands": "SLB", "Sierra Leone": "SLE", "El Salvador": "SLV", "Somaliland": "-99", "Somalia": "SOM", "Republic of Serbia": "SRB", "Suriname": "SUR", "Slovakia": "SVK", "Slovenia": "SVN", "Sweden": "SWE", "Swaziland": "SWZ", "Syria": "SYR", "Chad": "TCD", "Togo": "TGO", "Thailand": "THA", "Tajikistan": "TJK", "Turkmenistan": "TKM", "East Timor": "TLS", "Trinidad and Tobago": "TTO", "Tunisia": "TUN", "Turkey": "TUR", "Taiwan": "TWN", "United Republic of Tanzania": "TZA", "Uganda": "UGA", "Ukraine": "UKR", "Uruguay": "URY", "United States of America": "USA", "Uzbekistan": "UZB", "Venezuela": "VEN", "Vietnam": "VNM", "Vanuatu": "VUT", "West Bank": "PSE", "Yemen": "YEM", "South Africa": "ZAF", "Zambia": "ZMB", "Zimbabwe": "ZWE" };
...
var countryPopupTemplate = exports.countryPopupTemplate = function popupTemplate(geography, data) {
  if (geography.id === "USA") {
...
exports.mapMaker = exports.mapDiv = undefined;

var _datamaps = __webpack_require__(2);

var _datamaps2 = _interopRequireDefault(_datamaps);

var _popup_format = __webpack_require__(7);

var _data_format = __webpack_require__(5);

var _data_format2 = _interopRequireDefault(_data_format);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var mapDiv = exports.mapDiv = document.getElementById('basic-map');

var mapMaker = exports.mapMaker = function mapMaker(dataset, start, end) {
  return new _datamaps2.default({
    element: mapDiv,
    responsive: true,
    projection: 'mercator',
    fills: {
